...
class EBFacebookExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach (array('app_id', 'secret', 'default_target_route', 'firewall', 'register', 'extended_access_token', 'homepage', 'tab_url', 'app_params', 'tab_like', 'precontroller_exclude_route', 'precontroller_exclude_route_start', 'precontroller_exclude_pattern', 'skip_app', 'culture', 'translation', 'permissions', 'add_permissions', 'less_permissions', 'templates', 'fixcookie', 'user_class', 'form_class') as $attribute) {
